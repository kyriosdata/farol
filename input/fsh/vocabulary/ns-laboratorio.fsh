...
Description: "Declaração do identificador único de exame gerado por laboratório. Observe que não identifica unicamente um laboratório, mas que se trata de código único gerado por algum laboratório."
Usage: #definition
